...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'otp_limit': '3/minute',   # OTP limit
        'login_limit': '5/minute', # Login limit
    },
    "DEFAULT_THROTTLE_CACHE": "default",  # fallback işləsin
}
...
CELERY_RESULT_BACKEND = os.getenv("REDIS_BROKER_URL")
